...
STATIC_URL = '/munkiwebadmin/static_munkiwebadmin/'
...
_prefix = (RUN_ON_SUBPATH or "")
LOGIN_URL          = _prefix + '/login/'
LOGIN_REDIRECT_URL = _prefix + '/report/overview'
LOGOUT_URL         = _prefix + '/logout/'
ADMIN_MEDIA_PREFIX = _prefix + '/admin/'
...
MUNKI_REPO_DIR = '/Library/Server/Web/Data/Sites/Default/munki_repo/'
